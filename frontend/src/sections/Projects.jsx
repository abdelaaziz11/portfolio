...
export default function Projects() {
  ...
  const { data, loading, error } = useApi(api.projects.getAll);
      ...
      <div className="container" ref={ref}>
        ...
        {error && (
          <p style={{ color: 'var(--clr-accent)', textAlign: 'center', marginBottom: '1rem' }}>
            ⚠ Could not load projects from server — showing cached data.
          </p>
        )}
        ...
        <div className="projects-grid">
          {(loading ? portfolioData.projects : filtered).map((project, i) => (
            <ProjectCard
